...
class discuz_application extends discuz_base{
	...
	private function _init_config() {
		...
		define('LIBURL', !empty($_config['output']['liburl']) ? $_config['output']['liburl'] : 'static/lib');
		define('IMGURL', !empty($_config['output']['imgurl']) ? $_config['output']['imgurl'] : 'static/image');
		define('FONTURL', !empty($_config['output']['fonturl']) ? $_config['output']['fonturl'] : 'static/fonts');

		$this->var['staticurl'] = STATICURL;
		$this->var['liburl'] = LIBURL;
		$this->var['imgurl'] = IMGURL;
		$this->var['fonturl'] = FONTURL;
	...
	private function _init_mobile() {
		...
		$this->var['setting']['mobile']['simpletypeurl'] = [];
