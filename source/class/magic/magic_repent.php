...
class magic_repent {
	...
	function usesubmit() {
		...
		showmessage(lang('magic/repent', 'repent_succeed'), $post['first'] ? 'forum.php?mod=forumdisplay&fid='.$post['fid'] : dreferer(), [], array('alert' => 'right', 'showdialog' => 1, 'locationtime' => true));
	}
