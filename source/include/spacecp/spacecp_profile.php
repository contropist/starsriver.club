...
if(submitcheck('profilesubmit')) {
	...
	if(!empty($_GET['newpassword']) && $_GET['newpassword'] != addslashes($_GET['newpassword'])) {
		showmessage('profile_passwd_illegal', '', [], array('return' => true));
	}
	if(!empty($_GET['newpassword']) && $_GET['newpassword'] != $_GET['newpassword2']) {
		showmessage('profile_passwd_notmatch', '', [], array('return' => true));
	}
	...
	if($ucresult == -1) {
		showmessage('profile_passwd_wrong', '', [], array('return' => true));
	} elseif($ucresult == -4) {
		showmessage('profile_email_illegal', '', [], array('return' => true));
	} elseif($ucresult == -5) {
		showmessage('profile_email_domain_illegal', '', [], array('return' => true));
	} elseif($ucresult == -6) {
		showmessage('profile_email_duplicate', '', [], array('return' => true));
	}
...
if($operation == 'password') {
	...
	$actives = array('password' =>' class="active"');
