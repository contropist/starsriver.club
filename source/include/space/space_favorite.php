...
$actives[$_GET['type']] = ' class="active"';
...
if($count) {
	$icons = array(
		'tid'=>'<img src="'.IMGURL.'/feed/thread.gif" alt="thread"/> ',
		'fid'=>'<img src="'.IMGURL.'/feed/discuz.gif" alt="forum"/> ',
		'blogid'=>'<img src="'.IMGURL.'/feed/blog.gif" alt="blog"/> ',
		'gid'=>'<img src="'.IMGURL.'/feed/group.gif" alt="group"/> ',
		'uid'=>'<img src="'.IMGURL.'/feed/profile.gif" alt="space"/> ',
		'albumid'=>'<img src="'.IMGURL.'/feed/album.gif" alt="album"/> ',
		'aid'=>'<img src="'.IMGURL.'/feed/article.gif" alt="article"/> ',
	);
	$articles = [];
...
include_once template("nest:home/space_favorite");
