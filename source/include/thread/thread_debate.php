...
if($debate['affirmvotes'] || $debate['negavotes']) {
    if ($debate['affirmvotes'] && !$debate['negavotes']){
        $debate['negavoteswidth'] = 5;
        $debate['affirmvoteswidth'] = 95;
    } elseif (!$debate['affirmvotes'] && $debate['negavotes']){
        $debate['negavoteswidth'] = 95;
        $debate['affirmvoteswidth'] = 5;
    } else {
        $debate['negavoteswidth'] = intval($debate['negavotes'] / ($debate['affirmvotes'] + $debate['negavotes']) * 100);
        $debate['affirmvoteswidth'] = 100 - $debate['negavoteswidth'];
    }
} else {
    $debate['negavoteswidth'] = 50;
    $debate['affirmvoteswidth'] = 50;
}
