...
if($operation == 'optimize_unit') {
	...
	echo $_GET['checking'] ? '<a id="checking" class="btn_big">'.$lang['founder_optimizer_checking'].'</a>' :
...
END;
		...
		echo '<tr><td width="200" style="color:red;font-weight:700;"><a onclick="showoptions(this, \'ooclass\')">[-]</a> '.$lang['founder_optimizer_needopti'].'(<span id="optimizerablenum"></span>)</td><td width="350"></td><td></td></tr>';
		echo '</table>';
		echo '<table id="securityoption" class="tb tb2 tb3" style="margin-top:0;display:none;">';
		echo '<tr><td width="200" style="color:green;font-weight:700;"><a onclick="showoptions(this, \'soclass\')">[+]</a> '.$lang['founder_optimizer_safe'].'(<span id="securityoptionnum"></span>)</td><td width="350"></td><td></td></tr>';
		echo '</table>';
		echo '<table id="tipoption" class="tb tb2 tb3" style="margin-top:0;display:none;">';
		echo '<tr><td width="200" style="color:blue;font-weight:700;"><a onclick="showoptions(this, \'toclass\')">[+]</a> '.$lang['founder_optimizer_notice'].'(<span id="tipoptionnum"></span>)</td><td width="350"></td><td></td></tr>';
		echo '</table>';
	}
