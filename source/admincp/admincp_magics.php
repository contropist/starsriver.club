	...
	if(!submitcheck('magicsubmit')) {
		...
		foreach(C::t('common_magic')->fetch_all_data() as $magic) {
			...
			showtablerow('', array('class="td25"', 'class="td25"', 'class="td25"', 'class="td28"', 'class="td28"', 'class="td28"', 'class="td28"', '', ''), array(
				"<input type=\"checkbox\" name=\"delete[]\" value=\"$magic[magicid]\">",
				"<input type=\"text\" name=\"displayorder[$magic[magicid]]\" value=\"$magic[displayorder]\">",
				"<input type=\"checkbox\" name=\"available[$magic[magicid]]\" value=\"1\" ".($magic['available'] ? 'checked' : '').">",
				"<input type=\"text\" style=\"width:80px\" name=\"name[$magic[magicid]]\" value=\"$magic[name]\">".
				...
				"<input type=\"text\" name=\"price[$magic[magicid]]\" value=\"$magic[price]\">".$credits,
				"<input type=\"text\" name=\"num[$magic[magicid]]\" value=\"$magic[num]\">".
					($magic['supplytype'] ? '/ '.$magic['supplynum'].' / '.$lang['magic_suppytype_'.$magic['supplytype']] : ''),
				"<input type=\"text\" name=\"weight[$magic[magicid]]\" value=\"$magic[weight]\"><input type=\"hidden\" name=\"identifier[$magic[magicid]]\" value=\"$magic[identifier]\">",
		...
		foreach($newmagics as $newmagic) {
			...
			showtablerow('', array('class="td25"', 'class="td25"', 'class="td25"', 'class="td28"', 'class="td28"', 'class="td28"', 'class="td28"', '', ''), array(
				'',
				"<input type=\"text\" name=\"newdisplayorder[$newmagic[class]]\" value=\"0\">",
				"<input type=\"checkbox\" name=\"newavailable[$newmagic[class]]\" value=\"1\">",
				"<input type=\"text\" style=\"width:80px\" name=\"newname[$newmagic[class]]\" value=\"$newmagic[name]\">".
				...
				"<input type=\"text\" name=\"newprice[$newmagic[class]]\" value=\"$newmagic[price]\">".$credits,
				"<input type=\"text\" name=\"newnum[$newmagic[class]]\" value=\"0\">",
				"<input type=\"text\" name=\"newweight[$newmagic[class]]\" value=\"$newmagic[weight]\">",
