...
EOF;
		foreach(C::t('home_click')->fetch_all_by_idtype($idtype) as $click) {
			...
			showtablerow('', array('class="td25"', 'class="td28"', 'class="td25"', 'class="td25"', '', '', '', 'class="td23"', 'class="td25"'), array(
				"<input type=\"checkbox\" name=\"delete[]\" value=\"$click[clickid]\">",
				"<input type=\"text\" size=\"3\" name=\"displayorder[$click[clickid]]\" value=\"$click[displayorder]\">",
				"<img src=\"static/image/click/$click[icon]\">",
				"<input type=\"checkbox\" name=\"available[$click[clickid]]\" value=\"1\" $checkavailable>",
				"<input type=\"text\" size=\"10\" name=\"name[$click[clickid]]\" value=\"$click[name]\">",
				"<input type=\"text\" size=\"20\" name=\"icon[$click[clickid]]\" value=\"$click[icon]\">",
				$click['idtype']
			));
		}
