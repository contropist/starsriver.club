...
if(!submitcheck('modsubmit') && !$_GET['fast']) {
	...
	showtablerow('', array('width="60"', 'width="160"', 'width="60"'),
        ...
        showtablerow('', array('width="60"', 'width="160"', 'width="60"'),
                array(
                        "$lang[perpage]",
                        "<select name=\"tpp\">$tpp_options</select><label><input name=\"showcensor\" type=\"checkbox\" value=\"yes\" ".($showcensor ? ' checked="checked"' : '')."/> $lang[moderate_showcensor]</label>",
                        "$lang[moderate_bound]",
	...
	echo '<p class="margintop marginbot"><a onclick="expandall();">'.cplang('moderate_all_expand').'</a> &nbsp;<a onclick="foldall();">'.cplang('moderate_all_fold').'</a><p>';
	loadcache('forums');
