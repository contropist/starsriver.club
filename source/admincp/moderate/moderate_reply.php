...
if(!submitcheck('modsubmit') && !$_GET['fast']) {
	...
	showtablerow('', array('width="60"', 'width="160"', 'width="60"', 'colspan="3"'),
                array(
                        "$lang[perpage]",
                        "<select name=\"ppp\">$ppp_options</select><label><input name=\"showcensor\" type=\"checkbox\" value=\"yes\" ".($showcensor ? ' checked="checked"' : '')."/> $lang[moderate_showcensor]</label>",
                        "$lang[moderate_bound]",
