...
if(!empty($_G['setting']['makehtml']['flag']) && $article['htmlmade'] && !isset($_G['makehtml']) && empty($_GET['nest']) && empty($article['url'])) {
...
include_once template("nest:portal/view:{$catid}", NULL, $tpldirectory, NULL, $articleprimaltplname);
