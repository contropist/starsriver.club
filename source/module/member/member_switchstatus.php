...
if($_G['uid']) {
	...
	showmessage('<a href="member.php?mod=switchstatus" title="'.$language['login_switch_invisible_mode'].'" onclick="ajaxget(this.href, \'loginstatus\');return false;">'.$msg.'</a>', dreferer(), [], array('msgtype' => 3, 'showmsg' => 1));
