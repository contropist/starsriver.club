...
if($_GET['rss'] == 1) {
	...
	echo 	"<?xml version=\"1.0\" encoding=\"".$charset."\"?>\n".
		...
		"    <generator>Discuz! Board by Discuz Inc.</generator>\n".
...
loadcache('stamps');
$currentview[$view] = 'class="checked"';

$navigation = $view != 'index' ? '<em class="direct"></em><a href="forum.php?mod=guide&view='.$view.'">'.$lang['guide_'.$view].'</a>' : '';
