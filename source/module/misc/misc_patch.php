...
if($_GET['action'] == 'pluginnotice') {
	...
	if($newversion) {
		...
		echo '<div class="bm"><div class="bm_h cl"><a onclick="$(\'plugin_notice\').style.display=\'none\';setcookie(\'pluginnotice\', 1, 86400)" class="r" title="'.$lang['patch_close'].'">'.$lang['patch_close'].'</a>';
		...
		echo '<div class="ptn cl"><a href="webcontroller.php?action=plugins" class="xi2 y">'.$lang['plugin_link'].' &raquo;</a></div>';
		echo '</div></div>';
	}
