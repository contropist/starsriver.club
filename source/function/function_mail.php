...
function sendmail($toemail, $subject, $message, $from = '') {
    ...
    $siteurl = $_G['siteurl'];
    $clientip = $_G['clientip'] ? "用户IP:". $_G['clientip'] : '';
...
<meta http-equiv="X-UA-Compatible" content="IE=edge" /><title>$subject</title>
</head>
<body>
    <style>
        .starsriver_mail, 
        .starsriver_mail table{
        ...
        .starsriver_mail_content_titl{
            display: block;
            font-size: 20px;
            font-weight: 700;
            padding-bottom: 24px;
        }
        .starsriver_mail_content_para{
            padding: 6px;
            line-height: 24px;
            border: 6px solid #fff;
        }
        .starsriver_mail_content_para_method{
            background: #eee;
            padding: 10px;
            line-height: 24px;
            border: 6px solid #fff;
    ...
    <table class="starsriver_mail" align="center">
        <tbody style="background:#fff; border: 1px solid #e6e6e6">
            <tr>
                <td style="background: #39c5bb; color: #fff; padding: 16px;">
                    <table>
                        <tbody>
                            <tr>
                                <td style="width: 40%; word-break: keep-all;"><a style="color: #fff; font-size: 26px; font-weight: 700;" href="$siteurl">$bbname</a></td>
                                <td style="width: 60%; text-align: right">
                                    <span style="color:#fff; font-size: 13px; font-weight: 200;">该邮件由<a style="color: #fff; line-height: 20px; border-bottom:1px dashed #fff;" href="$siteurl" >$bbname</a>自动发送，请勿回复。</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <tr>
                <td class="starsriver_mail_content" style="padding:40px;">
                    <table>
                        <tbody>
                            $message
                        </tbody>
