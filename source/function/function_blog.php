<?php
    ...
    function blog_post($POST, $olds = []) {
        ...
        if ($uploads) {
            ...
            if ($albumid) {
                C::t('home_pic')->update_for_uid($_G['uid'], $picids, ['albumid' => $albumid]);
        ...
        if ($olds['blogid']) {
            ...
            C::t('common_member_status')->update($_G['uid'], ['lastpost' => $_G['timestamp']]);
            C::t('common_member_field_home')->update($_G['uid'], ['recentnote' => $POST['subject']]);
        }
