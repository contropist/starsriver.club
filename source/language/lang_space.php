 ...
 ********************************************************************/
    ...
    $lang = [
        ...
        'visitor_list'                     => '<a href="home.php?mod=space&uid={uid}" target="_blank" class="avt"><em class="{class}"></em><em class="{self}" onclick="removeVisitor(event, {cuid});" title="删除访问足迹"></em>{avatar}</a><p><a href="home.php?mod=space&uid={uid}" title="{username}">{username}</a></p>',
        'wall_form'                        => '<div class="space_wall_post">
						<form action="home.php?mod=spacecp&ac=comment" id="quickcommentform_{uid}" name="quickcommentform_{uid}" method="post" autocomplete="off" onsubmit="ajaxpost(\'quickcommentform_{uid}\', \'return_commentwall_{uid}\');doane(event);">
							...
							<input type="hidden" name="commentsubmit" value="true" />' : ($_G['connectguest'] ? '<div class="pt hm">你需要 <a href="member.php?mod=connect" class="xi2">完善帐号</a> 或 <a href="member.php?mod=connect&ac=bind" class="xi2">绑定帐号</a> 后才可以回复</div>' : '<div class="pt hm">你需要登录后才可以留言 <a href="member.php?mod=logging&action=login" onclick="showWindow(\'login\', this.href)" class="xi2">登录</a> | <a href="member.php?mod=' . $_G['setting']['regname'] . '" class="xi2">' . $_G['setting']['reglinkname'] . '</a></div>')) . '
        ...
        'poll_li'                          => '<div class="c z"><img alt="poll" src="' . IMGURL . '/feed/poll.gif" alt="poll"/><h4 class="h"><a target="_blank" href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a></h4><div class="mtn xg1">发布时间：{dateline}</div></div>',
        'music_no_content'                 => '还没有设置音乐盒的内容',
        'block_profile_nest'               => '装扮空间',
        'block_profile_wall'               => '查看留言',
        'block_profile_avatar'             => '编辑头像',
        'block_profile_update'             => '更新资料',
        'block_profile_follow'             => '查看话题',
        ...
        'block_album_no_content'           => '现在还没有画廊',
        'block_album_no_content_publish'   => '，<a href ="home.php?mod=spacecp&ac=upload">上传图片</a>',
        'block_feed_no_content'            => '现在还没有动态',
        'block_thread_no_content'          => '现在还没有文章',
        'block_thread_no_content_publish'  => '，<a href ="forum.php?mod=misc&action=nav&special=0&from=home" onclick="showWindow(\'nav\', this.href);return false;">发布文章</a>',
        ...
        'block_group_no_content'           => '现在还没有社团',
        'block_group_no_content_publish'   => '，<a href ="forum.php?mod=group&action=create">创建自己的社团</a> 或 <a href ="group.php?mod=index">加入社团</a>',
        'block_group_no_content_join'      => '，<a href ="group.php?mod=index">加入社团</a>',
        ...
        'export_pm'            => '导出私信',
        'pm_export_header'     => 'Discuz! X 私信记录(此消息记录不支持重新导入)',
        ...
        'viewthread_userinfo_threads'      => '文章',
        'viewthread_userinfo_doings'       => '记录',
        'viewthread_userinfo_blogs'        => '日志',
        'viewthread_userinfo_albums'       => '画廊',
        'viewthread_userinfo_sharings'     => '分享',
        'viewthread_userinfo_friends'      => '好友',
        'viewthread_userinfo_digest'       => '蜜制',
        'viewthread_userinfo_digestposts'  => '蜜制',
        ...
        'viewthread_userinfo_feeds'        => '话题',
        'viewthread_userinfo_privacy'      => '保密',
        'follow_view_follow'               => '我关注的',
        'follow_view_special'              => '特别关注',
        'follow_view_other'                => '话题大厅',
        'follow_view_feed'                 => '{who}的话题',
        'follow_view_thread'               => '{who}的文章',
        'follow_view_reply'                => '{who}的回复',
        'follow_view_profile'              => '{who}的个人资料',
        'follow_view_type_feed'            => '话题',
        'follow_view_type_thread'          => '文章',
        'follow_view_type_reply'           => '回复',
