...
(
	...
	'template_notfound' => '模版文件错误',
	'directory_notfound' => '目录错误',
	'request_tainting' => '请求含有非法字符',
	...
	'backtrace' => '运行信息',
	'error_end_message' => '<a href="http://{host}">{host}</a> 哎呀网站出错了( ° ▽、° ) 你可以将该信息反馈给服务娘来帮助我们排除BUG',
	'mobile_error_end_message' => '<a href="http://{host}">{host}</a> 哎呀网站出错了( ° ▽、° )',
