...
$lang = [
    ...
    'follow_relate_thread_null' => '没有相关文章',
    ...
    'follow_you_follower_none1' => '还没有人关注你',
    'follow_you_following_none' => '你还没有关注任何人',
    ...
    'poston' => '发表于',
    'follow_reply' => '转播',
    'follow_special_thread_tip' => '这是一个特殊文章，点击查看详细内容',
    'follow_thread_deleted' => '该文章已被删除',
    'follow_followed' => '已关注',
    ...
    'interactive_help_message' => '<li>来访用户：指的是每天访问本站的唯一用户数。一个用户访问多次，也只算一次</li>
                                    <li>{$_G[setting][navs][2][navname]}：指的是每天发布文章、投票、活动、悬赏、辩论、商品和文章回复的总数量 </li>
                                    <li>社团：指的是每天创建{$_G[setting][navs][3][navname]}、{$_G[setting][navs][3][navname]}文章、{$_G[setting][navs][3][navname]}回复的总数量 </li>
    ...
    'save_to' => '保存到',
    'second' => '秒',
    'select_album_please' => '请选择画廊',
    'select_album_type' => '请选择画廊分类',
    'select_type' => '选择分类',
    'series' => '连拍',
    'set_parameter' => '参数设置',
    ...
    'ver_message_1' => '程序需 FlashPlayer 9.0.45 以上版本你的播放器版本为',
    'ver_message_2' => '请升级',
    ...
    'edit' => '编辑',
    'explain_album' => '你在论坛或日志里面上传的图片附件，全部存放在 <a href="home.php?mod=space&uid=$space[uid]&do=album&id=-1" class="xw1 xi2">默认画廊</a> 里',
    'follow_search_album' => '以下是搜索画廊',
    'friend_album' => '好友的画廊',
    'friendname_1' => '仅好友可见',
    'friendname_2' => '指定好友可见',
    'friendname_3' => '仅自己可见',
    'friendname_4' => '凭密码可见',
    'hide_album' => '提示：本页有 $pricount 个画廊因作者的隐私设置而隐藏',
    'hide_pic' => '本页有 $pricount 张图片因作者的隐私设置或未通过而隐藏',
    'hot_pic_recommend' => '热门图片推荐',
    'my_album' => '我的画廊',
    'newest_update_album' => '最近更新的画廊',
    'no_album' => '没有可浏览的列表',
    'post_new_blog' => '发表新日志',
    'update' => '更新',
    'add_frame' => '加相框',
    ...
    'current_pic' => '{$sequence}/{$album[picnum]}',
    'edit_description' => '修改名称',
    'hot' => '热度',
    'hot_edit' => '编辑热度',
    'login' => '登录',
    'login_to_comment' => '评论前请登录',
    'no_comment' => '还没有人评论...',
    'whats_comment' => '这一刻你的想法...',
    'download' => '下载',
    ...
    'anonymity' => '匿名用户',
    'person' => '人',
    'position_friend' => '以下{$clicknum}位用户进行了表态',
    ...
    'doing_they' => 'TA 的所有记录',
    'doing_view_me' => '我的记录',
    'hide_doing' => '当前页面有 $pricount 条记录因未通过审核而隐藏',
    'me_friend_doing' => '我和好友的记录',
    'search' => '搜索',
    'somebody_doing' => '的记录',
    'doing_maxlimit_char' => '<i id="maxlimit">200</i>',
    ...
    'blacklist_message' => '加入到黑名单的用户，将会从你的好友列表中删除。同时，对方将不能进行与你相关的打招呼、踩日志、加好友、评论、留言、私信等互动行为 ',
    ...
    'friend_feed' => '好友的动态',
    'friends_birthday_reminder' => '好友生日',
    'friends_recommended' => '好友推荐',
    'gettable' => '可以获得',
    'home_show_members' => '续航排名',
    'hot_feed' => '热点动态',
    'invite_code' => '邀请码',
    'level' => '等级',
    'magic' => '道具',
    ...
    'no_feed' => '还没有相关动态',
    'no_record' => '还没有相关记录',
    'no_app_feed' => '还没有相关应用动态，<a href="home.php?mod=space&do=friend">添加好友能为你的在玩游戏时带来更多的互动</a>',
    'open' => '展开',
    'own' => '我在玩的',
    'profile_completed' => '你的资料已完成',
    'recent_recommended_hot' => '近期热点推荐',
    'recent_visit' => '最近来访',
    'shield_feed_message' => '有 $filtercount 条动态被屏蔽',
    'space_home_message' => '你好，$_G[username]，欢迎加入我们。有新任务等着你，挺简单的，赶快来参加吧',
    'step_up' => '提权',
    'task' => '任务',
    'they_feed' => 'TA 的近期动态',
    'today' => '今天',
    ...
    'profile_certified' => '<img class="check-mark" alt="已认证" src="{IMGURL}/common/icon/checked-2.svg"/>',
    'magics_log' => '道具记录',
    'magics_shop' => '道具商店',
    ...
    'default' => '默认',
    'magics_discount' => '可享受 <strong>{$_G[group][magicsdiscount]}</strong> 折优惠',
    'sold' => '已售出',
    'top' => '热门',
    'you_have_now' => '目前有',
    ...
    'manage_doing' => '管理记录',
    'manage_feed' => '管理动态',
    'manage_group_prune' => '社团回复',
    'manage_group_threads' => '社团文章',
    'manage_share' => '管理分享',
    'member_manage' => '用户管理',
    'message' => '留言板',
    'space_menu_send_pm' => '私信',
    ...
    'notice' => '提醒',
    'notice_warning_message' => '当你感觉有些通知对你造成骚扰时，请点击右侧小图标进行屏蔽',
    'notice_you_have' => '你有',
    'old_notice' => '已读提醒',
    'prompt' => '通知',
    'request' => '请求',
    ...
    'change_old_pm' => '标记已读',
    'delete_chatpm' => '解散群聊',
    'delete_chatpm_comment' => '解散该群聊话题',
    'delete_privatepm_user' => '删除与该用户的所有私信',
    'dots' => '……',
    'ignore_list' => '忽略名单',
    'ignore_member_pm_message' => '添加到该列表中的用户给你发送私信时将被拒接发送。<br>添加多个忽略人员名单时用逗号 <strong>","</strong> 隔开，如“ <strong> Auser, Buser, Cuser</strong>。<br>如需禁止所有用户发来的私信，请设置为 	<strong>&#123;ALL&#125;</strong>。',
    'just_now' => '刚刚',
    'kickmember' => '踢出',
    ...
    'pm_onlyacceptfriendpm' => '只接收好友的私信',
    'pm_setting' => '私信设置',
    'pm_totail' => '共有 $count 条记录',
    'pmignore' => '忽略',
    'private_pm' => '私信',
    'quit_chatpm' => '退出群聊',
    ...
    'sendmultipmwho' => '这是由 <a href="home.php?mod=space&uid=$grouppm[authorid]" target="_blank">$grouppm[author]</a> 发送的多人消息',
    'sendpm_tip' => '多个用户使用逗号、分号或回车提示系统分开',
    'view_newpm' => '点击这里查看 <strong>$newpmcount</strong> 条未读消息',
    'view_privatepm' => '查看全部私信',
    'yes' => '是',
    'you_to' => '对',
    'pmreport' => '举报',
    ...
    'register_ip' => '用户注册 IP',
    'seller_credit' => '卖家信用',
    'set_privacy' => '抱歉！由于 {$space[username]} 的隐私设置，你不能访问当前内容 ',
    'shares_num' => '分享',
    'space_visits' => '访客',
    'time_offset' => '所在时区',
    'timezone' => '
    ...
    'profile_no_certified' => '<img class="check-mark" alt="未认证" src="{IMGURL}/common/icon/uncheck-2.svg"/>',
    'profile_no_verified' => '<img class="check-mark" alt="未验证" src="{IMGURL}/common/icon/uncheck-2.svg"/>',
    'profile_verified' => '<img class="check-mark" alt="已验证" src="{IMGURL}/common/icon/checked-2.svg"/>',
    'replay_num' => '回复',
    'second_domain' => '二级域名',
    'spacenote' => '最新记录',
    'stat_info' => '统计信息',
    ...
    'description' => '描述',
    'help' => '帮助',
    'how_to_share_tips' => '<strong>如何分享视频？</strong><br>填写视频所在网页的网址。(不需要填写视频的真实地址)<br>我们支持的视频网站有：<br>Youtube、优酷、酷6、Mofile、偶偶视频、56、新浪视频、搜狐视频。<br><br><strong>如何分享音乐？</strong><br>填写音乐文件的地址。(后缀需要是 mp3 或者 wma)<br><br><strong>如何分享 Iframe？</strong><br>直接将包含Iframe的代码作为链接即可',
    'share_description' => '分享说明',
    'share_web_music_flash' => '分享网址、视频、音乐、Iframe',
    'sharemetoo' => '我也分享',
    'friend_share' => '好友的分享',
    ...
    'author' => '作者',
    'del_select_thread' => '删除选中文章',
    'del_select_thread_confirm' => '确定要删除选中的文章吗？',
    'forum' => '版块',
    'friend_post' => '好友的回复',
    'group' => '社团',
    'hide_thread' => '本页有 $hiddennum 篇文章因隐私问题而隐藏',
    'ignored' => '已忽略',
    'last_post' => '最后回复',
    'my_post' => '我的回复',
    'newest_thread' => '最新回复',
    ...
    'trade_units' => '元',
    'trade_unstart' => '未生效的',
    'follow_view_feed' => '查看话题',
    'click_view_message' => '点击此处查看全部留言',
    'leave_comments' => '留言',
    'login_to_wall' => '留言之前你需要先有个身份&nbsp;&nbsp;๑乛◡乛๑&nbsp;&nbsp;',
    'view_one_operation_message' => '当前只显示与你操作相关的单个留言',
    'adjust_hot' => '调整热度',
    'album_cover_notice' => '提示：你可以指定一张图片作为当前画廊的封面图片，但是，在下次上传新的图片后，系统会自动选择一张新图片来更新本画廊的封面图片 ',
    'album_depict' => '画廊描述',
    'back_album_list' => '返回画廊列表',
    'choices_following_friends_list' => '多次选择会累加到下面的好友名单',
    'completely_remove' => '彻底删除',
    'cover_pic' => '封面图片',
    'delete_album' => '删除画廊',
    'delete_album_message' => '确定删除画廊吗？',
    'delete_pic_notice' => '删除图片提示：如果你要删除的图片出现在你的文章、日志、话题中，删除后，会导致内容里面的图片同时无法显示 ',
    'determine' => '确定',
    'edit_album' => '编辑画廊',
    'edit_album_information' => '编辑画廊信息',
    'edit_pic' => '编辑图片',
    'friend_name_space' => '可以填写多个好友名，请用空格进行分割',
    'friendname_0' => '全站用户可见',
    'from_friends_group' => '从好友组选择好友',
    'move_to' => '转移到',
    'move_to_default_album' => '转移到 默认画廊',
    'new_hot' => '新的热度',
    'password' => '密码',
    'privacy_settings' => '隐私设置',
    'select_site_album_categories' => '选择一个站点分类，可以让你的画廊被更多的人浏览到',
    'set_to_conver' => '设为封面',
    'site_categories' => '站点分类',
    'specified_friends' => '指定好友',
    'the_album_pic' => '该画廊中的图片',
    'update_explain' => '更新说明',
    'view_album' => '查看画廊',
    'current_my_space' => '当前头像',
    'previous_page' => '返回上一页',
    'setting_avatar_message' => '如果你还没有设置自己的头像，系统会显示为默认头像，你需要自己上传一张新照片来作为自己的个人头像 ',
    'setting_my_new_avatar' => '设置我的新头像',
    'setting_my_new_avatar_message' => '头像保存后，你可能需要刷新或者清空浏览器缓存才能看到最新的头像效果。',
    'auto_keyword' => '自动获取',
    ...
    'edit_content' => '编辑内容',
    'bid_single_price' => '续航功率',
    'modify_unitprice' => '修改续航功率',
    'modify_unitprice_note' => '续航功率决定你的续航排名，功率越高，排名越靠前。站上会员访问一次你的个人主页将消耗相应的续航',
    'no_view_notice_next' => '将不再接收该类消息',
    'shield_all_friend' => '屏蔽所有好友的',
    'shield_notice' => '屏蔽通知',
    'shield_this_friend' => '仅屏蔽该好友的',
    'credits_give' => '给',
    'memcp_credits_addfunds' => '充值',
    'memcp_credits_addfunds_msg' => '你将要充值$extcredits[$creditstrans][title] $_GET[addfundamount] $extcredits[$fromcredits][unit]，所需人民币 $price 元<br>请选择支付方式：',
    ...
    'action_name' => '动作名称',
    'activity_award_message' => '进行以下事件动作，会得到积分奖励。在一个周期内，你最多得到的奖励次数有限制 ',
    'card' => '充值卡',
    'card_credit' => '充值卡充值',
    'card_use' => '立即充值',
    'changedateline' => '变更时间',
    ...
    'last_award_time' => '最后奖励',
    'memcp_credits_log_payment' => '文章付费',
    'srch' => '查询',
    'starttime_endtime' => '从',
    'total_time' => '总次数',
    'delete_log' => '删除记录',
    ...
    'follow_del_feed' => '删除话题',
    'follow_del_feed_confirm' => '确定删除指定的话题吗?',
    'follow_editnote' => '备注',
    'follow_word' => '字',
    ...
    'send_invitation_email_message' => '通过 Email 发送邮件的方式，邀请你的好友。多个 Email 使用 "," 分割',
    ...
    'determine_delete_gpmid' => '确定删除该公共私信吗？',
    'determine_delete_pm' => '确定删除与该用户的所有私人私信吗？',
    'determine_delete_pmid' => '确定删除该私信吗？',
    'determine_ignore_pm' => '确定把该用户加入忽略列表吗？',
    'determine_kickmember' => '确定把该用户踢出群聊吗？',
    'determine_quit_chatpm' => '确定退出该群聊消息吗？',
    'determine_report_pm' => '确定举报该私信吗？',
    'joiner' => '参与人',
    'offline' => '离线',
    'pm_appendmember' => '加入',
    'pm_ignore' => '忽略',
    ...
    'feed_filter' => '动态筛选',
    'filtering_rules_message_1' => '以下被勾选的用户组的动态将不会显示在你的主页上',
    'filtering_rules_message_2' => '下面是你已屏蔽的动态类型识别名和好友名',
    'filtering_rules_message_3' => '下面是你已屏蔽的通知类型和好友名',
    'filtering_rules_title_1' => '屏蔽指定用户组动态',
    'filtering_rules_title_2' => '被屏蔽的指定类型动态',
    'filtering_rules_title_3' => '被屏蔽的指定类型提醒',
    'forum_post' => '发表帖子',
    'forum_reply' => '回复帖子',
    'friend_add' => '添加好友',
    'friend_privacy' => '好友可见',
    ...
    'open_privacy' => '公开',
    'personal_feed' => '动态',
    'personal_feed_settings' => '动态关联',
    'personal_main_page' => '个人主页',
    'personal_privacy_settings' => '隐私设置',
    'pic_blog_position' => '对日志/图片表态',
    'pic_comment' => '图片评论',
    'pic_position' => '图片表态',
    'privacy_register' => '注册用户',
    ...
    'system' => '系统',
    'system_depend_action_message' => '以下勾选的内容变动将会出现在你的个人动态中',
    'theme' => '话题',
    'topic_comment' => '话题评论',
    'topic_reply' => '话题回复',
    'update_presonal_profile' => '更新个人资料',
    'view_my_certified_photo' => '查看认证照片',
    'view_right_setting_effective' => '相关浏览权限需要在发表时单独设置方可生效',
    'write_blog' => '撰写日志',
    'you_control_see_content' => '你可以完全控制哪些人可以看到你的主页上面的内容',
    'check_date_item' => '格式错误',
    'current_time' => '当前时间',
    'email' => '电子邮箱',
    'email_no' => '未绑定邮箱',
    'email_been_active' => '<img style="width:16px; vertical-align: sub;" src="{IMGURL}/common/icon/checked.svg"/> 当前邮箱已经验证激活',
    ...
    'spacecp_profile_message2' => '恭喜你，你的认证审核已经通过，下面的资料项已经不允许被修改',
    'spacecp_profile_safe' => '该信息将会被加密存储，可放心填写',
    'time_zone' => '时区',
    'time_zone_message' => '如果发现当前显示的时间与你本地时间相差几个小时，那么你需要更改自己的时区设置 ',
    'update_date_success' => '资料更新成功',
    'validator_comment' => '管理员否决了你的注册申请，请完善注册理由，重新提交申请',
    'validator_message' => '注册理由',
    'validator_remark' => '否决原因',
    'validator_submit' => '重新提交申请',
    'space_domain' => '我的空间域名',
    'mode_two_desc' => '通过点击文章标题旁的“复制链接”，推广成功后也可以获得积分奖励',
    'post_promotion' => '如果你的朋友通过下面任意一个链接访问站点并注册新会员，你将获得积分奖励<span class="imp">$regstr</span>',
    'post_promotion_reg' => '如果你的朋友不但访问并且注册成为会员，你将再获得积分奖励<span class="imp">$regstr</span>',
    'post_promotion_url' => '如果你的朋友通过下面任意一个链接访问站点，你将获得积分奖励<span class="imp">$visitstr</span>',
    'promotion_url_copied' => '链接复制成功',
    'advance_seek' => '高级方式查找',
    'age_segment' => '年龄段',
    'birth_city' => '出生地',
    'birthday' => '生日',
    ...
    'search_member_list_message' => '以下是查找到的用户列表(最多显示 100 个)，你还可以<a href="home.php?mod=spacecp&ac=search">换个搜索条件试试</a>',
    'seek' => '查找',
    ...
    'mail_pcomment' => '我的文章被人评论',
    'mail_piccomment' => '我的画廊被评论',
    'mail_post' => '我的文章被人回复',
    'mail_pusearticle' => '我的日志或回复被推送成文章',
    'mail_reward' => '悬赏文章回复被设为最佳答案',
    ...
    'share_copylink' => '地址复制成功<br>你可以用快捷键 Ctrl + V 粘贴到 QQ、MSN 里',
    'share_count' => '已有 <b>$share_count</b> 人分享',
    'share_im' => '通过 QQ、MSN 分享给朋友',
    'hide_app' => '隐藏应用',
    'hide_app_message' => '确定要隐藏该应用吗？',
    'add_to_existing_album' => '添加到现有画廊',
    'back_to_my_album' => '返回我的画廊',
    'camera_pic' => '大头贴',
    'common_upload' => '普通上传',
    ...
    'upload_pic_tips' => '<p>从电脑中选择你要上传的图片。<br>提示：选择图片后，你可以继续选择图片，这样就可以一次上传多张图片了 </p>',
    'you_can_buy_magictools' => '你可以购买道具“{$_G[setting][magics][attachsize]}”来增加附件容量，上传更多的附件',
    'about_space' => '家园相关',
    'bytes' => '字节',
    'forum_name' => '版块名称',
    'free' => '免费',
    'free_danger' => '免费（存在降权风险）',
    'free_buy' => '免费购买',
    'main_usergroup' => '&nbsp;&nbsp;<strong class="heart-pink">（当前用户组）</strong>',
    'memcp_usergroup_unallow' => '非常抱歉，本站暂时还没有推出可以购买的用户组',
    'memcp_usergroups_admin_exit_comment' => '注意: 该组不是开放用户组，一旦你退出，只有管理员才能将你重新加入进来',
    'memcp_usergroups_credit' => '你当前可以购买',
    'memcp_usergroups_dailyprice' => '每日消费',
    'memcp_usergroups_exit' => '退出',
    'memcp_usergroups_exit_comment' => '本操作不可恢复，你退出收费用户组后，如需再次加入，将<strong>&nbsp;重新支付&nbsp;</strong>相应的费用，因此请在提交前仔细确定是否退出本组。',
    'memcp_usergroups_explain' => '说明',
    'memcp_usergroups_free_comment' => '加入该组是免费的，且没有时间限制，你可以随时加入或者退出',
    'memcp_usergroups_join_comment' => '该用户组可以根据日价格按天购买，但是不能少于<strong>&nbsp;$group[minspan]&nbsp;</strong>天。请注意，购买后不能退款。',
    'memcp_usergroups_joinbuy' => '购买用户组 <strong class="heart-pink">$group[grouptitle]</strong>',
    'memcp_usergroups_joinexit' => '退出用户组 <strong class="heart-pink">$group[grouptitle]</strong>',
    ...
    'my_main_usergroup' => '当前组',
    'permission_attachment_nopermission' => '无限',
    'permission_basic_disable_search' => '禁用搜索',
    'permission_basic_search_content' => '允许搜索回复内容',
    'permission_basic_search_title' => '只允许搜索标题',
    'permission_menu_attachment' => '附件相关',
    'permission_menu_normaloptions' => '普通权限',
    'permission_menu_post' => '回复相关',
    ...
    'usergroup_right_message3' => '表示必须拥有的指定认证',
    'youhave' => '你目前有',
    'yourusergroup' => '当前用户组',
    'my' => '我的',
    'my_usergroups' => '我的用户组',
    ...
    'freeze_reason' => '申诉理由',
    'freeze_reason_comment' => '如果你无法通过邮箱验证，请填写申诉理由',
    ...
    'register_rejected' => '系统提示：注册理由不充分，管理员不予以通过。请重新提交注册理由以示真诚 (,,•́ . •̀,,) 。<br>（请勿在注册理由中填写违规违纪内容）',
];
?>