...
(
	'highlight_name' => '变色卡',
	'highlight_desc' => '可以将回复或日志的标题高亮，变更颜色',
	'highlight_expiration' => '高亮有效期',
	'highlight_expiration_comment' => '设置标题可以被高亮多长时间，默认 24 小时。作用于日志时无有效期。',
	'highlight_forum' => '允许使用本道具的版块',
	'highlight_info_tid' => '高亮文章的标题 {expiration} 小时',
	'highlight_info_blogid' => '可以将日志或回复的标题高亮，变更颜色',
	'highlight_color' => '颜色',
	'highlight_info_nonexistence_tid' => '请指定要高亮的文章',
	'highlight_info_nonexistence_blogid' => '请指定要高亮的日志',
	'highlight_succeed_tid' => '你操作的文章已高亮',
	'highlight_succeed_blogid' => '你操作的日志已高亮',
	'highlight_info_noperm' => '对不起，文章所在版块不允许使用本道具',
	'highlight_info_notype' => '参数错误，没有指定操作类型。',

	'highlight_notification' => '你的文章 {subject} 被 {actor} 使用了{magicname}，<a href="forum.php?mod=viewthread&tid={tid}">快去看看吧！</a>',
