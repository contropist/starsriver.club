...
$lang = array (
  ...
  'nesthelp_doit' => '自己动手，让自己拥有个性的页面。请点击上面的按钮开始 NEST，或者',
  'nesthelp_import' => '导入程序现有模板',
  'nesthelp_no_content' => '正在建设中，请稍候……',
  'nesthelp_start_nest' => '开始 NEST',
  'frame' => '框架',
  'article_author' => '原作者',
  ...
  'portalcp_article_message2' => '提示：$pushedcount 个文章已经在连载中了',
  'select' => '选择',
  'select_color' => '点击选择颜色',
  'submit' => '提交',
  'view_article' => '查看文章',
  ...
  'point' => '点',
  'portalcp_block_message1' => '提醒： 你选择了隐藏输出，模块不会输出任何内容；但是你可以在页面模板中调用模块的数据。',
  ...
  'nest_change' => '更换',
  'nest_editing' => '正在编辑',
  'nest_systemfile' => '系统内置',
  'nest_update_start' => '开始上传',
  'nest_upload_image' => '上传新图片',
  'nest_uploadfile' => '上传文件',
  'image_position' => '图片位置',
  'image_repeat' => '平铺',
  ...
  'portalcp_has_no_category' => '你还没有创建任何频道栏目',
  'portalcp_index_message' => '你还没有可管理的频道栏目',
  'block_recommend_data_in_block' => '已推送的模块',
  'has_no_block' => '快去设置几个模块啊，这里空空如也',
  'select_block' => '未推送的模块',
  'admin_pm' => '通知作者',
  'all_page' => '全部页面',
  ...
  'topic_domain' => '二级域名',
  'topic_domain_comment' => '根域名设置完后，此处域名绑定才能生效，<a href="webcontroller.php?action=domain&operation=root&highlight=专题" target="_blank">设置根域名</a>，专题的二级域名，不能重复',
  'topic_edit' => '编辑专题',
  ...
  'topic_submit' => '专题标题',
  'topic_tplname_comment' => '请将模板文件上传到模板目录的portal目录下，如：template/default/portal目录下，文件名必须为portal_topic_*.html，*为自定义文件名<br>如果要重新选择模板，请确保新模板与原模板中可拖拽区域具有相同的ID，否则将会丢失分部或全部原NEST数据',
  'tplname' => '模板名',
