...
$lang = array (
  ...
  'register_message' => '注册理由',
  'register_message1' => '你填写的注册理由会被当作申请注册的重要参考依据，写的越多越好听表示你越有诚意哦 (ฅ´ω`ฅ)。',
  ...
  'register_validate_email_tips' => '注册需要验证邮箱，请务必填写正确的邮箱，提交后请及时查收邮件。<br />你可能需要等待几分钟才能收到邮件，如果收件箱没有，请检查一下垃圾邮件箱。',
  'rulemessage' => '网站服务条款',
);
