...
(
	...
	'threadlist_uids' => '作者UID',
	'threadlist_uids_comment' => '设置要作者UID，多个UID请用半角逗号“,”隔开。',
	'threadlist_startrow' => '起始数据行数',
	'threadlist_startrow_comment' => '如需设定起始的数据行数，请输入具体数值，0 为从第一行开始，以此类推',
	'threadlist_items' => '显示数据条数',
	'threadlist_items_comment' => '设置一次显示的文章条目数，请设置为大于 0 的整数',
	...
	'threadlist_summarylength' => '文章简短内容文字数',
	'threadlist_summarylength_comment' => '设置文章简短内容的文字数，0 为使用默认值 255',
	'threadlist_tids' => '指定文章',
	'threadlist_tids_comment' => '设置要指定显示的文章 tid ，多个 tid 请用半角逗号“,”隔开。注意: 留空为不进行任何过滤',
	...
	'threadlist_typeids' => '文章分类ID',
	'threadlist_typeids_comment' => '输入文章分类ID，多个 ID 之间用半角逗号“,”隔开。',
	'threadlist_typeids_all' => '全部的文章分类',
	'threadlist_sortids' => '分类信息',
	'threadlist_sortids_comment' => '设置特定分类信息的文章。注意: 全选或全不选均为不进行任何过滤',
	'threadlist_sortids_all' => '全部的分类信息',
	'threadlist_reply' => '无回复文章过滤',
	'threadlist_digest' => '蜜制文章过滤',
	'threadlist_digest_comment' => '设置特定的文章范围。注意: 全选或全不选均为不进行任何过滤',
	'threadlist_digest_0' => '普通文章',
	'threadlist_digest_1' => '蜜制 I',
	'threadlist_digest_2' => '蜜制 II',
	'threadlist_digest_3' => '蜜制 III',
	'threadlist_stick' => '置顶文章过滤',
	'threadlist_stick_comment' => '设置特定的文章范围。注意: 全选或全不选均为不进行任何过滤',
	'threadlist_stick_0' => '普通文章',
	'threadlist_stick_1' => '置顶 I',
	'threadlist_stick_2' => '置顶 II',
	'threadlist_stick_3' => '置顶 III',
	'threadlist_special' => '特殊文章过滤',
	'threadlist_special_comment' => '设置特定的文章范围。注意: 全选或全不选均为不进行任何过滤',
	'threadlist_special_1' => '投票文章',
	'threadlist_special_2' => '商品文章',
	'threadlist_special_3' => '悬赏文章',
	'threadlist_special_4' => '活动文章',
	'threadlist_special_5' => '辩论文章',
	'threadlist_special_0' => '普通文章',
	'threadlist_special_reward' => '悬赏文章过滤',
	'threadlist_special_reward_comment' => '设置特定类型的悬赏文章',
	'threadlist_special_reward_0' => '全部',
	'threadlist_special_reward_1' => '已解决',
	'threadlist_special_reward_2' => '未解决',
	'threadlist_recommend' => '推荐文章过滤',
	'threadlist_viewmod' => '文章模式查看',
	'threadlist_recommend_comment' => '设置是否只显示推荐的文章',
	'threadlist_picrequired' => '必须含图片附件',
	'threadlist_picrequired_comment' => '设置是否只显示含有图片附件的文章',
	'threadlist_orderby' => '文章排序方式',
	'threadlist_orderby_comment' => '设置以哪一字段或方式对文章进行排序',
	...
	'threadlist_orderby_recommends' => '按文章评价倒序排序',
	...
	'threadlist_postdateline' => '文章发布时间',
