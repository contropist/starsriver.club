...
(
	...
	'sortlist_showitems_comment' => '设置一次显示的文章条目数，请设置为大于 0 的整数',
	...
	'sortlist_summarylength' => '文章简短内容文字数',
	'sortlist_summarylength_comment' => '设置文章简短内容的文字数，0 为使用默认值 255',
	'sortlist_tids' => '指定文章',
	'sortlist_tids_comment' => '设置要指定显示的文章 tid ，多个 tid 请用半角逗号“,”隔开。注意: 留空为不进行任何过滤',
	...
	'sortlist_typeids' => '文章分类',
	'sortlist_typeids_comment' => '设置特定分类的文章。注意: 全选或全不选均为不进行任何过滤',
	'sortlist_typeids_all' => '全部的文章分类',
	'sortlist_sortids' => '分类信息',
	'sortlist_sortids_comment' => '设置特定分类信息的文章。注意: 全选或全不选均为不进行任何过滤',
	'sortlist_sortids_all' => '全部的分类信息',
	'sortlist_digest' => '蜜制文章过滤',
	'sortlist_digest_comment' => '设置特定的文章范围。注意: 全选或全不选均为不进行任何过滤',
	'sortlist_digest_0' => '普通文章',
	'sortlist_digest_1' => '蜜制 I',
	'sortlist_digest_2' => '蜜制 II',
	'sortlist_digest_3' => '蜜制 III',
	'sortlist_stick' => '置顶文章过滤',
	'sortlist_stick_comment' => '设置特定的文章范围。注意: 全选或全不选均为不进行任何过滤',
	'sortlist_stick_0' => '普通文章',
	'sortlist_stick_1' => '置顶 I',
	'sortlist_stick_2' => '置顶 II',
	'sortlist_stick_3' => '置顶 III',
	'sortlist_special' => '特殊文章过滤',
	'sortlist_special_comment' => '设置特定的文章范围。注意: 全选或全不选均为不进行任何过滤',
	'sortlist_special_1' => '投票文章',
	'sortlist_special_2' => '商品文章',
	'sortlist_special_3' => '悬赏文章',
	'sortlist_special_4' => '活动文章',
	'sortlist_special_5' => '辩论文章',
	'sortlist_special_0' => '普通文章',
	'sortlist_special_reward' => '悬赏文章过滤',
	'sortlist_special_reward_comment' => '设置特定类型的悬赏文章',
	'sortlist_special_reward_0' => '全部',
	'sortlist_special_reward_1' => '已解决',
	'sortlist_special_reward_2' => '未解决',
	'sortlist_recommend' => '推荐文章过滤',
	'sortlist_recommend_comment' => '设置是否只显示推荐的文章',
	'sortlist_orderby' => '文章排序方式',
	'sortlist_orderby_comment' => '设置以哪一字段或方式对文章进行排序',
	...
	'sortlist_orderby_recommends' => '按文章评价倒序排序',
	'sortlist_lastpost' => '文章发布时间',
