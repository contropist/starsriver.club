    ...
    (function() {
        ...
        v.onload = function() {
            ...
            button.addEventListener('click', function(e) {
                ...
                stopPropagation(e);
                var html = '$please_finish_validation'
                if(vaptchaContainer) {
                    vaptchaContainer.style.display = 'block';
                    return ;
                }
                ...
                vaptchaContainer.innerHTML = '<div class="vaptcha-mask"></div><div class="vaptcha-mobile-main"><div class="vaptcha-mobile-close"><span class="vaptcha-mobile-close-img"></span></div><div class="vaptcha-pop"><div class="vaptcha-mobile-title">$please_finish_validation</div><div id="vaptcha" class="vaptcha"><div class="loading"><span style="animation-delay: -.32s"></span><span style="animation-delay: -.16s"></span><span></span></div></div></div></div>';
