...
class WeChatServer {
	...
	public function __construct($token, $hooks = []) {
		$this->_token = $token;
		$this->_hooks = $hooks;
		$this->accessDataPush();
	}
...
class WeChatClient {
	...
	private $_appid;
	private $_appsecret;
	private static $_accessTokenCache = [];
	private static $ERROR_LOGS = [];
	...
	public function getQrcodeTicket($options = []) {
		$access_token = $this->getAccessToken();
...
class WeChatHook {
	...
	public static function getPluginUrl($pluginid, $param = []) {
		global $_G;
