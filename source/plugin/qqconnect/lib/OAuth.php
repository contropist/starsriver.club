...
class Cloud_Service_Client_OAuth {
	...
	public function dfsockopen($requestURL, $queryString = [], $files = false) {
	...
	public function getRequest($requestURL, $extra = [], $oauthMethod = 'GET', $multi = []) {
	...
	private function _getOAuthSignatureParams($extra = []) {
	...
	private function _httpBuildQuery($params, $multi = []) {
