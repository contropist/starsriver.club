...
function sdisplay(id, obj) {
	obj.innerHTML = $(id).style.display == 'none' ? '<img src="static/image/admincp/src/img/desc.gif" style="vertical-align:middle" />' : '<img src="static/image/admincp/src/img/add.gif" style="vertical-align:middle" />';
	display(id);
}
